...
export class ReviewService {
    ...
    public async submitReview(sitterId: string, clientId: string, bookingId: string, rating: number, comment?: string): Promise<any> {
    ...
    public async getAverageRating(sitterId: string): Promise<number> {
    ...
    public async getReviewsBySitter(sitterId: string): Promise<any[]> {
        const query = `
