 ...
 */
function checkinCheckoutHandler(event) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let booking;
            if (action === 'CHECK_IN') {
                booking = yield bookingService.updateBookingToActive(sitterId, bookingId);
            }
            else { // action === 'CHECK_OUT'
                booking = yield bookingService.updateBookingToCompleted(sitterId, bookingId);
            }
