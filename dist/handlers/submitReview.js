...
function submitReviewHandler(event) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const { sitter_id } = yield bookingService.validateReviewEligibility(bookingId, clientId);
            const review = yield reviewService.submitReview(sitter_id, clientId, bookingId, rating, comment);
            return {
                statusCode: 201,
                body: JSON.stringify({
